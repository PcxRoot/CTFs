...
Lo encontramos!! El último fragmento que nos falta se encuentra el el directorio `/medi/tuxling_2/` en el cual encontramos una nueva nota, una clave privada y un fragmento con la extensión `.asc`. Para más información sobre ***[[#PGP (Pretty Good Privacy)]]***.
...
>Para saber el porque: ***[[#Python3 Permission denied]]***.
